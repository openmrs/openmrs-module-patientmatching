...
/**
 * Class created to write MatchingConfig name in JList in SessionsPanel, since
 * MatchingConfig's toString() method returns a String too long for JList.
 * 
 * Instead, this class will return the MatchingConfig's getName() method results.
 * @author jegg
 *
 */
