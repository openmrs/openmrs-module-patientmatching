...
public class ApplyAnalyzerLoggingFrame extends LoggingFrame {
	...
	/**
	 * Apply the u value generated from the random sampling to the non-agreement field of the current
	...
	private void applyValue() {
		 ...
		 */
		MatchingConfig analyzerConfig = (newConfig == null)
		        ? ((MatchingConfigAnalyzer) logSources.get(0)).getAnalyzerMatchingConfig()
		        : newConfig;
		...
		JOptionPane.showMessageDialog(this, "Values copied to current session parameter.", "Info",
