...
public class ConfigurationEntry implements Comparable<ConfigurationEntry> {
	...
	static {
		...
		System.out.println("ConfigurationEntry entity called");
	}
	/**
	...
	public String getInclusion() {
		System.out.println("getInclusion()...................." + inclusion);
		return inclusion;
	}
	...
	public void setInclusion(String level) {
		System.out.println("setInclusion(String level)....................."
				+ level);
	...
	public String getSET() {
		...
		System.out.println("getSET() ................." + flag);
	...
	public void setIncluded() {
		System.out.println("setIncluded()  called");
