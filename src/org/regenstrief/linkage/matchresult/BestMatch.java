...
/**
 * Class filters a stream of MatchResult objects, only storing the one with the highest score.
 * Only higher scoring matches replace the current best, so the first match of the highest
 * score encountered will be returned.
 * 
 * @author jegg
 *
 */
...
public class BestMatch implements MatchResultHandler {
	...
	/**
	 * Method returns the highest scoring MatchResult the object
