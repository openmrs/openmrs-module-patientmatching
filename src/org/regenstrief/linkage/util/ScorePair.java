...
public class ScorePair {
	...
	{
		String rec1ConcatValue = rec1.getDemographic("concat1");
		String rec2ConcatValue = rec2.getDemographic("concat1");
		boolean empty = rec1ConcatValue.isEmpty() & rec2ConcatValue.isEmpty();
		if(! empty)
		{
			 boolean match = StringMatch.LCSMatch(rec1ConcatValue,rec2ConcatValue,0.85);
		if(match)
		{
