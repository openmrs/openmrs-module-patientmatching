 ...
 * implementation will require multiple creation of this class object to fully read the entire
 * report content. Future implementation might use a singleton pattern and create only a single
 * instance of this class to read the entire content.
 */
public class MatchingReportReader {
	...
	/**
	 * Default paging size of the report. This indicate the total number of lines that will be displayed
	 * in the show report web page.
	 */
	public static final int REPORT_PAGE_SIZE = 20;
	
	/**
	 * Cache for each page offset from the start of the file. Element i-th will contains the page offset
	 * of the i-th page of the report.
	 */
	...
	/**
	 * Current content of the report that will be displayed in the web page. One element of the list,
	 * which is a list of string, correspond to a single row in the report web page.
	 */
	private List<List<String>> currentContent;
	
	/**
	 * File name on the file system of the report currently being displayed in the report web page
	 */
	private File reportFile;
	
	/**
	 * Flag to denote whether the report viewing reaches the end of file. This will also determine
	 * whether user can do "view next page" or not.
	 */
	private boolean eof = false;
	
	/**
	 * Constructor to read a particular report file. Use this constructor for initial viewing of a
	 * report web page. The sequence for initial viewing of a report page are: - Call this constructor -
	 * Call getHeader() - Call fetchContent(int) - Call getCurrentContent() Future implementation might
	 * combine the fetchContent(int) and the call to getCurrentContent()
	 */
	...
	/**
	 * Subsequent call to view next or previous page will use this constructor. The sequence when using
	 * this constructor are: - Call this constructor - Call fetchContent(int) - Call getCurrentContent
	 * 
	...
	/**
	 * Check whether the current reading process reach the end of the report or not. This particularly
	 * important to determine whether user are allowed to view the next page or not.
	 * 
	 * @return the eof
	 */
	...
	/**
	 * Set the flag to determine whether the reading process reach the end of the report file or not
	 * 
	...
	/**
	 * Method to get the cache page offset for the current report file. The cache is used to speed up
	 * the report file reading process. Element i will contain the page offset of the i-th page of the
	 * report
	 * 
	 * @return the pagePos
	 */
	...
	/**
	 * Return list of string that will be used as the report header. The list will be read from the
	 * first line of the report file.
	 * 
	...
	/**
	 * Return the current content of the page. One element of the list, which is a list of string,
	 * correspond to a single row in the report web page.
	 * 
	...
	/**
	 * This method call will try to get the content of the currently requested report page. This report
	 * reading process will utilize the offset cache in which the offset cache will contains at least a
	 * single entry from the getHeader process. This method will fill up a buffer and the buffer can be
	 * retrieved using the getCurrentContent() method call. The reading process will be performed until
	 * the buffer is full or the end of file is reached, whichever comes first.
	 * 
