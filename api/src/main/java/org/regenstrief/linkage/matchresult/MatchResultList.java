...
/**
 * Class stores MatchResults and makes them available for later using the MatchResultStore interface
 * 
 * @author jegg
 */
...
public class MatchResultList implements MatchResultHandler, MatchResultStore {
	...
	/**
	 * Method returns a MatchResult at the given index in it's internal list of MatchResults
	 */
