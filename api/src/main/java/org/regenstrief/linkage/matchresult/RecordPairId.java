...
public class RecordPairId {
	...
	/**
	 * flag denoting whether this record pair has been processed for flattening process
	 */
	...
	/**
	 * Convenience method to check if a RecordPairId contains certain id or not
	 * 
	...
	public boolean flattenable(RecordPairId otherPairId) {
		if (contains(otherPairId.getFirstRecordId()) || contains(otherPairId.getSecondRecordId())) {
			return true;
		} else {
			return false;
		}
