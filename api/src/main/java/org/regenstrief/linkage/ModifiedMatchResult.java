...
/**
 * Class used by analysis modifiers for when a basic matching score is modified.  This takes
 * the basic MatchResult object, but stores the 
 * @author jegg
 *
 */
...
public class ModifiedMatchResult extends MatchResult {
	...
	public static enum Operator{PLUS, MULTIPLY};
	...
	public ModifiedMatchResult(MatchResult mr){
		super(mr.getScore(), mr.getInclusiveScore(), mr.getTrueProbability(), mr.getFalseProbability(), mr.getSensitivity(), mr.getSpecificity(), mr.getMatchVector(), mr.getScoreVector(), mr.getRecord1(), mr.getRecord2(), mr.getMatchingConfig());
		base = mr;
