...
public interface DataSourceReader {
	...
	/**
	 * Resets the DataSourceReader to start returning Records in order from the first Record.
	 * 
	...
	/**
	 * Method releases resources held by the reader, such as file handles or database connections. As
	 * written, once closed a DataSourceReader cannot be reopened.
	 * 
	 * @return
	 */
