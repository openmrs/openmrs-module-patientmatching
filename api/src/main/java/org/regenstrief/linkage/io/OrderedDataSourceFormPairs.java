...
/**
 * Class makes pairs between two DataSourceReaders. The expectation that the DataSourceReaders will
 * return the Records in order when sorted on the blocking variables allows this class to find pairs
 * of Records while iterating through the readers without storing previous Records.
 */
public class OrderedDataSourceFormPairs extends FormPairs {
	 ...
	 * @param type_table indexes Record field names and holds what type (String or numeric) of data they
	 *            are
	 */
	public OrderedDataSourceFormPairs(OrderedDataSourceReader dsr1, OrderedDataSourceReader dsr2, MatchingConfig mc,
	...
	/**
	 * Returns the next pair of Record objects from the two DataSourceReaders that have equivalent
	 * blocking variable values. If there are no more pairs, it returns null.
	 * 
