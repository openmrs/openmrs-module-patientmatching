...
public class MatchingConfig implements Cloneable {
	 ...
	 * 
	 * @return an array of the column names included in the analysis, including blocking columns
	 */
	...
	/**
	 * Method returns the names of the columns used in the comparison, excluding blocking columns.
	 * 
	 * @return
	 */
