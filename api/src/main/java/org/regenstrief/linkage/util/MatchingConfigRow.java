...
public class MatchingConfigRow implements Cloneable {
	...
	/**
	 * Returns a string representing the old C program meta file format. This was used as the toString()
	 * method before being updated to something that is read more easily
	 * 
	 * @return a String with the options in a .meta file format
	 */
	public String getMetaString() {
		String ret = new String();
		ret += name + "," + block_order + "," + block_chars + "," + include + "," + agreement + "," + non_agreement + ","
		        + scale_weight + "," + algorithm;
		return ret;
	}
