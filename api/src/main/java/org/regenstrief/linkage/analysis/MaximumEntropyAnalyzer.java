...
public class MaximumEntropyAnalyzer extends DataSourceAnalyzer {
	...
	public MaximumEntropyAnalyzer(LinkDataSource lds, MatchingConfig mc, TreeMap<String, Double> computed_average_freq_table,
	...
	public void finishAnalysis() {
		...
		while (demographic_it.hasNext()) {
			...
			log.info("column/demographic " + current_demographic + " has maximum entropy: " + mxent);
