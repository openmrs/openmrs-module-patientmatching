...
/**
 * Class checks two records to see if they are likely to be twins. Current default rules that will
 * be implemented are: FNs disagree and MRNs disagree Genders both not null and Genders disagree FNs
 * disagree and Genders disagree FNs disagree and at least one MRN null An initial check for
 * different MRNs are done and if they are the same, then the method immediately returns false.
 * 
 * @author jegg
 */
...
public class TwinAnalyzer {
	...
	public boolean areTwins(Record rec1, Record rec2) {
		...
		if (fn1 != null && fn2 != null && !fn1.equals(fn2) && gender1 != null && gender2 != null
