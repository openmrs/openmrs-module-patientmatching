...
/**
 * Class created to provide information on specific column score values to store the individual
 * scores that made up the final score. It will be stored in a MatchResult object by ScorePair and
 * used by Modifier objects.
 * 
 * @author jegg
 */
...
public class ScoreVector {
	...
	/**
	 * Method sets an entry to store whether the two records matched on the given demographic.
	 * 
